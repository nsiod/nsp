...
export const en = {
  ...
  users: {
    ...
    toggleProxyAria: 'Toggle Proxy for {{name}}',
    ...
    toasts: {
      ...
      enableProxyFailed: 'Enable proxy failed',
      disableProxyFailed: 'Disable proxy failed',
    ...
    reveal: {
      ...
      proxyTitle: 'Proxy credentials for {{name}}',
  ...
  userDetail: {
    ...
    proxy: {
      title: 'Proxy (SOCKS5 + HTTP)',
      subtitle: 'Single credential pair shared across SOCKS5 and HTTP CONNECT.',
      enable: 'Enable proxy',
      rotate: 'Rotate password',
      confirmDisable: 'Disable proxy for this user?',
      confirmRotate: 'Rotate the proxy password? Existing clients will stop working.',
      revealCreated: 'Proxy enabled — {{name}}',
      revealRotated: 'Proxy rotated — {{name}}',
      meta: {
        username: 'Username',
        socks5: 'SOCKS5 URL',
        http: 'HTTP URL',
  ...
  services: {
    ...
    descriptions: {
      ...
      proxy: 'SOCKS5 + HTTP CONNECT on independent ports. Per-user credentials shared across both protocols.',
    },
    metrics: {
      users: 'Users',
      reloads: 'Reloads',
